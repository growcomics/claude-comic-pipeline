...
if ($do === 'gg_qa') {
    ...
    $sys = 'You are a strict QA inspector for an ALWAYS-SFW comic. You are shown ONE AI-generated image (a comic panel or a reference sheet). Check, in priority order:'
        ...
        . "\nGROWTH-BEAT CALIBRATION: panels showing muscle GROWTH IN PROGRESS (swelling body parts filling the frame, radial speed-lines, SFX like FWOOMP/BAAAM/RRRIP baked in) are INTENTIONALLY exaggerated — enormous ballooning muscle on a growth beat is the product, NOT an anatomy defect, and the baked SFX text is intentional, NOT a text artifact. On such panels flag anatomy only for genuine breakage: muscle bursting OUT of clothing as exposed skin, fabric disappearing, fused/melted forms, wrong number of limbs/fingers."
