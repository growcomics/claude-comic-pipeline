...
| `costume_discontinuity` | HIGH | 4 | 4 | 3 | 0 | 100% | 57% |
...
| `character_count_error` | med/low | 2 | 0 | 1 | 2 | 0% | 0% |
...
| `p01-03` | BAD | empty_speech_bubble, lettering_error | (none) | missed: lettering_error,empty_speech_bubble;  |
| `p02-01` | GOOD | — | costume_discontinuity(m) | FALSE ALARMS: costume_discontinuity |
| `p02-02` | BAD | character_identity_swap, lettering_error | lettering_error(h), character_count_error(m) | hits: lettering_error; missed: character_identity_swap; extra: character_count_error |
| `p02-03` | BAD | costume_discontinuity | costume_discontinuity(h), scale_error(h) | hits: costume_discontinuity; extra: scale_error |
| `p02-04` | BAD | hair_discontinuity | (none) | missed: hair_discontinuity;  |
| `p03-04` | GOOD | — | (none) | clean |
| `p04-01` | BAD | lettering_error | costume_discontinuity(h), lettering_error(m) | hits: lettering_error; extra: costume_discontinuity |
| `p04-02` | GOOD | — | costume_discontinuity(h) | FALSE ALARMS: costume_discontinuity |
| `p04-03` | GOOD | — | (none) | clean |
| `p04-04` | BAD | costume_discontinuity | costume_discontinuity(h) | hits: costume_discontinuity;  |
| `p05-01` | BAD | costume_discontinuity | costume_discontinuity(h) | hits: costume_discontinuity;  |
