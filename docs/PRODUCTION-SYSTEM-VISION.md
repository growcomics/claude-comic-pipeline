...
**The build priority writes itself: with the ideator engine live (1) and the publisher's prep half in (7), the Writer (2) is the last missing stage — land it and the line runs seed → published comic.** The middle is done.
